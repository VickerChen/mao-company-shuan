...
public class RulerView extends View {
    ...
    protected void init(Context context, AttributeSet attrs) {
        ...
        final TypedArray typedArray = context.obtainStyledAttributes(attrs,
                com.zkk.view.rulerview.R.styleable.RulerView);

        mAlphaEnable = typedArray.getBoolean(com.zkk.view.rulerview.R.styleable.RulerView_alphaEnable, mAlphaEnable);

        mLineSpaceWidth = typedArray.getDimension(com.zkk.view.rulerview.R.styleable.RulerView_lineSpaceWidth, mLineSpaceWidth);
        mLineWidth = typedArray.getDimension(com.zkk.view.rulerview.R.styleable.RulerView_lineWidth, mLineWidth);
        mLineMaxHeight = typedArray.getDimension(com.zkk.view.rulerview.R.styleable.RulerView_lineMaxHeight, mLineMaxHeight);
        mLineMidHeight = typedArray.getDimension(com.zkk.view.rulerview.R.styleable.RulerView_lineMidHeight, mLineMidHeight);
        mLineMinHeight = typedArray.getDimension(com.zkk.view.rulerview.R.styleable.RulerView_lineMinHeight, mLineMinHeight);
        mLineColor = typedArray.getColor(com.zkk.view.rulerview.R.styleable.RulerView_lineColor, mLineColor);

        mTextSize = typedArray.getDimension(com.zkk.view.rulerview.R.styleable.RulerView_textSize,  mTextSize);
        mTextColor = typedArray.getColor(com.zkk.view.rulerview.R.styleable.RulerView_textColor, mTextColor);
        mTextMarginTop = typedArray.getDimension(com.zkk.view.rulerview.R.styleable.RulerView_textMarginTop, mTextMarginTop);

        mSelectorValue = typedArray.getFloat(com.zkk.view.rulerview.R.styleable.RulerView_selectorValue, 0.0f);
        mMinValue = typedArray.getFloat(com.zkk.view.rulerview.R.styleable.RulerView_minValue, 0.0f);
        mMaxValue = typedArray.getFloat(com.zkk.view.rulerview.R.styleable.RulerView_maxValue, 100.0f);
        mPerValue = typedArray.getFloat(com.zkk.view.rulerview.R.styleable.RulerView_perValue, 0.1f);

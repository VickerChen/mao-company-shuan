...
public class BMIView extends View {
    ...
    private String mHeaderText = "BMI"; // 表头
    ...
    private SweepGradient generateSweepGradient() {
        SweepGradient sweepGradient = new SweepGradient(mCenterX, mCenterY,
                new int[]{Color.argb(80, 255, 255, 255), Color.argb(240, 255, 255, 255)},
    ...
    private float calculateRelativeAngleWithValue(int value) {
        ...
        if (value > 80) {
            return 8 * degreePerSection + 2* (value - 80) ;
        } else if (value > 60) {
            return 6 * degreePerSection + 2* (value - 60) ;
        } else if (value > 40) {
            return 4 * degreePerSection + 2* (value - 40) ;
        } else if (value > 20) {
            return 2 * degreePerSection + 2* (value - 20);
        } else {
            return 2* value ;
        }
    }

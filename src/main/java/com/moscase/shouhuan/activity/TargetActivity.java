...
//                TimePickerView pvTime = new TimePickerView.Builder(TargetActivity.this, new TimePickerView.OnTimeSelectListener() {
//                    @Override
...
//        });
    ...
    private void setQianKa(int value) {
        int tizhong = DataSupport.find(MyInfoBean.class, 1).getTizhong();
        int temp = (int) (value*(tizhong*0.000693-0.0045));
